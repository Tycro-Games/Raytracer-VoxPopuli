...
#ifdef _MSC_VER
using BYTE = unsigned char; // for freeimage.h
using WORD = unsigned short; // for freeimage.h
using DWORD = unsigned long; // for freeimage.h
using BOOL = int; // for freeimage.h
#endif
...
#include "Lighting/SphereAreaLight.h"
//materials
